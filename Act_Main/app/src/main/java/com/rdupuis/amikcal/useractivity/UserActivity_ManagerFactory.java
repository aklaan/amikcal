...
public class UserActivity_ManagerFactory {
    ...
    public static UserActivity_Manager getManager(Activity activity, UserActivity userActivity) {
        ...
        switch (userActivity.getActivityType()) {
            case LUNCH:
                return new UserActivity_Lunch_Manager(activity, userActivity);
            case MOVE:
                return new UserActivity_Move_Manager(activity, userActivity);
            case WEIGHT:
                return new UserActivity_Weight_Manager(activity, userActivity);
        }
