 ...
 public class MultipleItemsActivityList extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                case TYPE_WEIGHT:
                        convertView = mInflater.inflate(R.layout.item_activity_weight, null);
                        ...
                        Weight w = new Weight(map.get("titre"));
                        tv.setText(w.format());
                ...
                case TYPE_ACTIVITY:
                        convertView = mInflater.inflate(R.layout.item_activity_activity, null);
                ...
                case TYPE_LUNCH:
                default:
                    convertView = mInflater.inflate(R.layout.item_activity_lunch, null);
