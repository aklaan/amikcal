...
public final class AmiKcalFactory {
	...
	if (cursor.moveToFirst()) {
		...
		((Food) energy).setStructure(map_struct._in.get(cursor.getInt(INDX_NRJ_STRUCTURE)));
		break;
	    case BURN:
		// TODO
	    default:
	...
	Uri selectUri = ContentUris.withAppendedId(ContentDescriptorObj.View_NRJ_QtyRef.VIEW_NRJ_QTYREF_URI, NRJ_id);
	Cursor cursor = this.contentResolver.query(selectUri, null, null, null, null);
