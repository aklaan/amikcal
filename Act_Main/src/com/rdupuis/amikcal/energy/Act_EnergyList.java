...
public class Act_EnergyList extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(R.id.energy_list_view_tv_filter))
	...
	protected void generateList() {
		...
		SimpleAdapter mSchedule = new SimpleAdapter(this.getBaseContext(),
				listItem, R.layout.list_item_energy_food,

				new String[] { "name", "energy" }, new int[] {
						R.id.item_energy_food_name,
						R.id.item_energy_food_nbkcal

				/*
				 * new String[] {"name", "energy",
				 * "lipids","proteins","glucids"}, new int[]
     ...
     * Action a effectuer lorsque l'on séléctionne une énergie
     */
