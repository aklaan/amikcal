...
public final class ContentDescriptorObj {
	...
	public static final Uri S01_PARTY_REL_BY_ID_URI = BASE_URI.buildUpon().appendPath(S01_PARTY_REL_BY_ID_PATH)
		.build();
	...
	public static final Uri S03_ALL_EQUIV_FOR_UAC_URI = BASE_URI.buildUpon().appendPath(S03_ALL_EQUIV_FOR_UAC_PATH)
		.build();
	...
	matcher.addURI(authority, TB_Party_rel.S03_ALL_EQUIV_FOR_UAC_PATH, TB_Party_rel.S03_ALL_EQUIV_FOR_UAC_TOKEN);
