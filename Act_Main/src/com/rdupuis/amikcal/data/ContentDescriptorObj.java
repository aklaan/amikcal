...
public final class ContentDescriptorObj {
	...
	public static UriMatcher buildUriMatcher() {
		...
		matcher.addURI(authority, TB_UserActivities.SELECT_ALL_USER_ACTIVITIES_PATH,
				TB_UserActivities.SELECT_ALL_USER_ACTIVITIES_TOKEN);
	...
	public static final class CustomQuery {
		...
		public static final int SUM_ENERGY_OF_DAY_TOKEN = getToken(CSTM_QUERY,
				SQL_ORDER.SELECT, +0);
		...
		public static final int DB_VERSION_TOKEN = getToken(CSTM_QUERY,
				SQL_ORDER.SELECT, +1);
		public static final Uri URI_DB_VERSION = BASE_URI.buildUpon()
				.appendPath(DB_VERSION_PATH).build();

		public static final int LAST_WEIGHT_FROM_TOKEN = getToken(CSTM_QUERY,
				SQL_ORDER.SELECT, +2);
		...
		public static final int USED_UNITS_FOR_ENERGY_TOKEN = getToken(
				CSTM_QUERY, SQL_ORDER.SELECT, +3);
	...
	public static final class TB_Party_rel implements BaseColumns {
		...
		public static final int SEL000_PARTY_REL_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.SELECT, +0);
		...
		public static final int SEL001_PARTY_REL_BY_ID_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +1);
		...
		public static final int SEL002_ALL_UAC_FOR_UA_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +2);
		...
		public static final int SEL003_ALL_EQUIV_FOR_UAC_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +4);
		...
		public static final int SEL004_QTY_REF_INTER_FOR_NRJ_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +5);
		...
		public static final int SEL005_EQUIV_REF_INTER_FOR_NRJ_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +6);
		...
		public static final int INS000_PARTY_REL_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.INSERT, +0);
		...
		public static final int UPD000_PARTY_REL_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.UPDATE, +0);
	...
	public static final class TB_Energies implements BaseColumns {
		...
		public static final int SELECT_ENERGIES_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.SELECT, +0);

		// Path pour l'Uri de séléction d'un enregistrement via son ID
		public static final String SELECT_ENERGY_BY_ID = "energies/#";
		public static final int SELECT_ENERGY_BY_ID_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.SELECT, +1);
		...
		public static final int SELECT_ENERGIES_LIKE_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.SELECT, +2);
		...
		public static final int INSERT_ENERGY_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.INSERT, +0);

		// Path pour l'Uri pour l'UPDATE d'un enregistrement
		public static final String UPDATE_ENERGY = "update_energy";
		// id table + code Select + n° de select
		public static final int UPDATE_ENERGY_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.UPDATE, +0);
	...
	public static final class TB_Units implements BaseColumns {
		...
		public static final int SELECT_UNITS_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.SELECT, +0);

		// Path pour l'Uri de séléction d'un enregistrement
		public static final String SELECT_UNIT_BY_ID = "units/#";
		public static final int SELECT_UNIT_BY_ID_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.SELECT, +1);

		public static final String INSERT_UNIT = "insert_unit";
		public static final int INSERT_UNIT_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.INSERT, +0);

		public static final String UPDATE_UNIT = "update_unit";
		public static final int UPDATE_UNIT_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.UPDATE, +0);
	...
	public static final class TB_Capacities implements BaseColumns {
		...
		public static final int SELECT_CAPACITIES_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.SELECT, +0);

		// Path pour l'Uri de séléction d'un enregistrement
		public static final String SELECT_CAPACITY_BY_ID = "capacities/#";
		public static final int SELECT_CAPACITY_BY_ID_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +1);
	...
	public static final class TB_UserActivities implements BaseColumns {
		...
		public static final String SELECT_ALL_USER_ACTIVITIES_PATH = "select_all";
		public static final int SELECT_ALL_USER_ACTIVITIES_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +0);
		public static final Uri SELECT_ALL_USER_ACTIVITIES_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT_ALL_USER_ACTIVITIES_PATH)
				.build();

		// URI de selections d'une UserActivity
		// URI: user_activities/select/#
		public static final String SELECT_USER_ACTIVITY_BY_ID_PATH = SELECT + "/#";
		public static final int SELECT_USER_ACTIVITY_BY_ID_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +1);
		public static final Uri SELECT_USER_ACTIVITY_BY_ID_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT_USER_ACTIVITY_BY_ID_PATH).build();

		// URI de selections des UserActivities d'un même type
		// URI: user_activities/type/#
		public static final String SELECT_USER_ACTIVITIES_BY_TYPE_PATH = "type/?";
		public static final int SELECT_USER_ACTIVITIES_BY_TYPE_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +2);
		public static final Uri SELECT_USER_ACTIVITIES_BY_TYPE_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT_USER_ACTIVITIES_BY_TYPE_PATH)
				.build();

		// URI de selections des UserActivities d'une même journée
		// URI: user_activities/date/#
		public static final String SELECT_USER_ACTIVITIES_BY_DATE_PATH = "date/#";
		public static final int SELECT_USER_ACTIVITIES_BY_DATE_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.SELECT, +3);
		public static final Uri SELECT_USER_ACTIVITIES_BY_DATE_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT_USER_ACTIVITIES_BY_DATE_PATH).build();
		...
		public static final int INSERT_USER_ACTIVITY_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.INSERT, +0);
		public static final Uri INSERT_USER_ACTIVITY_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(INSERT_USER_ACTIVITY_PATH).build();
		...
		public static final int UPDATE_USER_ACTIVITIES_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.UPDATE, +0);
		public static final Uri UPDATE_USER_ACTIVITIES_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(UPDATE_USER_ACTIVITIES_PATH).build();
		...
		public static final int UPDATE_USER_ACTIVITY_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.UPDATE, +1);
		public static final Uri UPDATE_USER_ACTIVITY_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(UPDATE_USER_ACTIVITY_PATH).build();
		...
		public static final int DELETE_USER_ACTIVITIES_TOKEN = getToken(
				TABLE_ID, SQL_ORDER.DELETE, +0);
		...
		public static final int DELETE_USER_ACTIVITY_TOKEN = getToken(TABLE_ID,
				SQL_ORDER.DELETE, +1);
		public static final Uri DELETE_USER_ACTIVITY_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(DELETE_USER_ACTIVITY_PATH).build();
	...
	public static final class View_NRJ_QtyRef {
		...
		public static final int VIEW_NRJ_QTYREF_TOKEN = getToken(VIEW_ID,
				SQL_ORDER.SELECT, +0);
	...
	public static final class View_UAC_Data {
		...
		public static final int VIEW_UAC_DATA_TOKEN = getToken(VIEW_ID,
				SQL_ORDER.SELECT, +1);
	...
	public static final class View_UA_UAC_link {
		...
		public static final int VIEW_UAC_FOR_UA_TOKEN = getToken(VIEW_ID,
				SQL_ORDER.SELECT, +1);
	...
	public static final class View_Qty {
		...
		public static final int VIEW_QTY_BY_ID_TOKEN = getToken(VIEW_ID,
				SQL_ORDER.SELECT, +0);
	...
	public static final class XX_View_Energies implements BaseColumns {
		...
		public static final int SELECT_VIEW_ENERGIES_TOKEN = getToken(VIEW_ID,
				SQL_ORDER.SELECT, +0);

		// Path pour l'Uri de séléction d'un enregistrement
		public static final String SELECT_VIEW_ENERGIES_BY_ID = "view_energies/#";
		public static final int SELECT_VIEW_ENERGIES_BY_ID_TOKEN = getToken(
				VIEW_ID, SQL_ORDER.SELECT, +1);
	...
	public static final class TOKEN_MAP {
		...
		public TOKEN_MAP() {
			_in.put(TB_Party_rel.SEL000_PARTY_REL_TOKEN, REQUESTS_LIST.NONE);
			_in.put(TB_Party_rel.SEL001_PARTY_REL_BY_ID_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_Party_rel.SEL002_ALL_UAC_FOR_UA_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_Party_rel.SEL003_ALL_EQUIV_FOR_UAC_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_Party_rel.SEL004_QTY_REF_INTER_FOR_NRJ_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_Party_rel.SEL005_EQUIV_REF_INTER_FOR_NRJ_TOKEN,
					REQUESTS_LIST.NONE);
			...
			_in.put(TB_Energies.SELECT_ENERGIES_TOKEN,
					REQUESTS_LIST.SELECT_ALL_ENERGIES);
			_in.put(TB_Energies.SELECT_ENERGY_BY_ID_TOKEN,
					REQUESTS_LIST.SELECT_ENERGY);
			...
			_in.put(TB_UserActivities.SELECT_ALL_USER_ACTIVITIES_TOKEN,
					REQUESTS_LIST.NONE);
			...
			_in.put(TB_Units.SELECT_UNIT_BY_ID_TOKEN,
					REQUESTS_LIST.SELECT_UNITY_BY_ID);
			...
			//
			_in.put(TB_Energies.UPDATE_ENERGY_TOKEN,
