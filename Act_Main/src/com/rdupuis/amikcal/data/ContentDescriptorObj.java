...
public final class ContentDescriptorObj {
	...
	matcher.addURI(authority, TB_Party_rel.SEL000_PARTY_REL_PATH, TB_Party_rel.SEL000_PARTY_REL_TOKEN);

	matcher.addURI(authority, TB_Party_rel.SEL001_PARTY_REL_BY_ID_PATH, TB_Party_rel.SEL001_PARTY_REL_BY_ID_TOKEN);

	matcher.addURI(authority, TB_Party_rel.SEL002_ALL_UAC_FOR_UA_PATH, TB_Party_rel.SEL002_ALL_UAC_FOR_UA_TOKEN);

	matcher.addURI(authority, TB_Party_rel.SEL003_ALL_EQUIV_FOR_UAC_PATH,
		TB_Party_rel.SEL003_ALL_EQUIV_FOR_UAC_TOKEN);

	matcher.addURI(authority, TB_Party_rel.SEL004_QTY_REF_INTER_FOR_NRJ_PATH,
		TB_Party_rel.SEL004_QTY_REF_INTER_FOR_NRJ_TOKEN);

	matcher.addURI(authority, TB_Party_rel.SEL005_EQUIV_REF_INTER_FOR_NRJ_PATH,
	...
	matcher.addURI(authority, TB_Units.SELECT_UNITS, TB_Units.SELECT_UNITS_TOKEN);
	matcher.addURI(authority, TB_Units.SELECT_UNIT_BY_ID, TB_Units.SELECT_UNIT_BY_ID_TOKEN);
	...
	matcher.addURI(authority, TB_UserActivities.SELECT_USER_ACTIVITIES_BY_ID,
	...
	public static final int SEL000_PARTY_REL_TOKEN = getToken(TABLE_ID, SQL_ORDER.SELECT, +0);
	public static final Uri SEL000_PARTY_REL_URI = BASE_URI.buildUpon().appendPath(SEL000_PARTY_REL_PATH).build();
	...
	public static final int SEL001_PARTY_REL_BY_ID_TOKEN = getToken(TABLE_ID, SQL_ORDER.SELECT, +1);
	public static final Uri SEL001_PARTY_REL_BY_ID_URI = BASE_URI.buildUpon()
		.appendPath(SEL001_PARTY_REL_BY_ID_PATH).build();
	...
	public static final int SEL002_ALL_UAC_FOR_UA_TOKEN = getToken(TABLE_ID, SQL_ORDER.SELECT, +2);
	public static final Uri SEL002_ALL_UAC_FOR_UA_URI = BASE_URI.buildUpon().appendPath(SEL002_ALL_UAC_FOR_UA_PATH)
		.build();
	...
	public static final int SEL003_ALL_EQUIV_FOR_UAC_TOKEN = getToken(TABLE_ID, SQL_ORDER.SELECT, +4);
	public static final Uri SEL003_ALL_EQUIV_FOR_UAC_URI = BASE_URI.buildUpon()
		.appendPath(SEL003_ALL_EQUIV_FOR_UAC_PATH).build();
	...
	public static final int SEL004_QTY_REF_INTER_FOR_NRJ_TOKEN = getToken(TABLE_ID, SQL_ORDER.SELECT, +5);
	public static final Uri SEL004_QTY_REF_INTER_FOR_NRJ_URI = BASE_URI.buildUpon()
		.appendPath(SEL004_QTY_REF_INTER_FOR_NRJ_PATH).build();
	...
	public static final int SEL005_EQUIV_REF_INTER_FOR_NRJ_TOKEN = getToken(TABLE_ID, SQL_ORDER.SELECT, +6);
	public static final Uri SEL005_EQUIV_REF_INTER_FOR_NRJ_URI = BASE_URI.buildUpon()
		.appendPath(SEL005_EQUIV_REF_INTER_FOR_NRJ_PATH).build();
	...
	public static final int SELECT_UNIT_BY_ID_TOKEN = getToken(TABLE_ID, SQL_ORDER.SELECT, +1);
	...
	public TOKEN_MAP() {
	    ...
	    _in.put(TB_Party_rel.SEL001_PARTY_REL_BY_ID_TOKEN, REQUESTS_LIST.NONE);
	    _in.put(TB_Party_rel.SEL002_ALL_UAC_FOR_UA_TOKEN, REQUESTS_LIST.NONE);
	    _in.put(TB_Party_rel.SEL003_ALL_EQUIV_FOR_UAC_TOKEN, REQUESTS_LIST.NONE);
	    _in.put(TB_Party_rel.SEL004_QTY_REF_INTER_FOR_NRJ_TOKEN, REQUESTS_LIST.NONE);
	    _in.put(TB_Party_rel.SEL005_EQUIV_REF_INTER_FOR_NRJ_TOKEN, REQUESTS_LIST.NONE);
