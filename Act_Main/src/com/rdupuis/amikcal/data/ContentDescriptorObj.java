...
public final class ContentDescriptorObj {
	...
	public static final class CustomQuery {
		...
		public static final Uri URI_DB_VERSION = BASE_URI.buildUpon()
				.appendPath(DB_VERSION_PATH).build();
	...
	public static final class TB_Party_rel implements BaseColumns {
		...
		public static final Uri S00_PARTY_REL_URI = BASE_URI.buildUpon()
				.appendPath(S00_PARTY_REL_PATH).build();
		...
		public static final int S02_ALL_UAC_FOR_UA_TOKEN = 1102;
		public static final Uri S02_ALL_UAC_FOR_UA_URI = BASE_URI.buildUpon()
				.appendPath(S02_ALL_UAC_FOR_UA_PATH).build();
		...
		public static final int S03_ALL_EQUIV_FOR_UAC_TOKEN = 1103;
		public static final Uri S03_ALL_EQUIV_FOR_UAC_URI = BASE_URI
				.buildUpon().appendPath(S03_ALL_EQUIV_FOR_UAC_PATH).build();
		...
		public static final int S04_QTY_REF_INTER_FOR_NRJ_TOKEN = 1104;
		public static final Uri S04_QTY_REF_INTER_FOR_NRJ_URI = BASE_URI
				.buildUpon().appendPath(S04_QTY_REF_INTER_FOR_NRJ_PATH).build();
		...
		public static final int S05_EQUIV_REF_INTER_FOR_NRJ_TOKEN = 1105;
		public static final Uri S05_EQUIV_REF_INTER_FOR_NRJ_URI = BASE_URI
				.buildUpon().appendPath(S05_EQUIV_REF_INTER_FOR_NRJ_PATH)
				.build();
	...
	public static final class TB_Energies implements BaseColumns {
		...
		public static final Uri URI_BASE_ENERGIES = BASE_URI.buildUpon()
				.appendPath(TBNAME).build();

		// Path pour l'Uri de séléction de toute les énergies
		public static final String SELECT_ALL_ENERGIES_PATH = TBNAME + "/"
				+ SELECT + "_all";
		public static final int SELECT_ALL_ENERGIES_TOKEN = 2100;
		public static final Uri SELECT_ALL_ENERGIES_URI = URI_BASE_ENERGIES
				.buildUpon().appendPath(SELECT + "_all").build();

		// Path pour l'Uri de séléction d'une énergie via son ID
		// # := obligatoirement un numérique
		public static final String SELECT_ONE_ENERGY_BY_ID_PATH = TBNAME + "/"
				+ SELECT + "_id/#";
		public static final int SELECT_ONE_ENERGY_BY_ID_TOKEN = 2101;
		public static final Uri SELECT_ONE_ENERGIES_BY_ID_URI = URI_BASE_ENERGIES
				.buildUpon().appendPath(SELECT + "_id").build();

		// Path pour l'Uri de séléction d'un enregistrement dont le nom resemble
		// * := chaine de caractère
		public static final String SELECT_ENERGIES_LIKE_PATH = TBNAME + "/"
				+ SELECT + "_like/*";
		public static final int SELECT_ENERGIES_LIKE_TOKEN = 2102;
		public static final Uri SELECT_ENERGIES_LIKE_URI = URI_BASE_ENERGIES
				.buildUpon().appendPath(SELECT + "_like").build();
		...
		public static final Uri INSERT_ENERGY_URI = URI_BASE_ENERGIES
				.buildUpon().appendPath(INSERT).build();

		// Path pour l'Uri pour l'UPDATE d'un enregistrement
		public static final String UPDATE_ENERGY_ID_PATH = TBNAME + "/"
				+ UPDATE + "_id/#";
		public static final int UPDATE_ENERGY_ID_TOKEN = 2300;
		public static final Uri UPDATE_ENERGY_ID_URI = URI_BASE_ENERGIES
				.buildUpon().appendPath(UPDATE + "_id").build();
		...
		public static final class PredefinedValues {
			public static final class StructureCode {
				...
				public static final int LIQUID = 0x01;
	...
	public static final class TB_Units implements BaseColumns {
		...
		public static final Uri URI_SELECT_UNIT = BASE_URI.buildUpon()
				.appendPath(SELECT_ALL_UNITS).build();
	...
	public static final class TB_UserActivities implements BaseColumns {
		...
		public static final String S00_USER_ACTIVITIES_PATH = TBNAME + "/"
				+ SELECT;
		public static final int S00_USER_ACTIVITIES_TOKEN = 5100;
		public static final Uri S00_USER_ACTIVITIES_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT).build();

		// URI de selections d'une UserActivity
		// URI: /user_activities/select_id/#
		public static final String SELECT_USER_ACTIVITY_BY_ID_PATH = TBNAME
				+ "/" + SELECT + "_id/#";
		public static final int SELECT_USER_ACTIVITY_BY_ID_TOKEN = 5101;
		public static final Uri SELECT_USER_ACTIVITY_BY_ID_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT + "_id").build();

		// URI de selections des UserActivities d'un même type
		// URI: user_activities/select_type/#
		public static final String SELECT_USER_ACTIVITIES_BY_TYPE_PATH = TBNAME
				+ "/" + SELECT + "_type/#";
		public static int SELECT_USER_ACTIVITIES_BY_TYPE_TOKEN = 5102;
		public static final Uri SELECT_USER_ACTIVITIES_BY_TYPE_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT + "_type").build();
		...
		public static final String SELECT_USER_ACTIVITIES_BY_DATE_PATH = TBNAME
				+ "/" + SELECT + "_day/*";
		public static final int SELECT_USER_ACTIVITIES_BY_DATE_TOKEN = 5103;
		public static final Uri SELECT_USER_ACTIVITIES_BY_DATE_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(SELECT + "_day").build();

		// Path pour l'Uri de création d'un enregistrement
		// URI: user_activities/insert
		public static final String INSERT_USER_ACTIVITY_PATH = TBNAME + "/"
				+ INSERT;
		public static final int INSERT_USER_ACTIVITY_TOKEN = 5201;
		public static final Uri INSERT_USER_ACTIVITY_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(INSERT).build();
		...
		public static final String UPDATE_USER_ACTIVITIES_PATH = TBNAME + "/"
				+ UPDATE + "_all";
		public static final Uri UPDATE_USER_ACTIVITIES_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(UPDATE + "_all").build();

		// Path pour l'Uri de modification d'un enregistrement
		// URI: user_activities/update/#
		public static final String UPDATE_USER_ACTIVITY_PATH = TBNAME + "/"
				+ UPDATE + "_id/#";
		public static final int UPDATE_USER_ACTIVITY_TOKEN = 5301;
		public static final Uri UPDATE_USER_ACTIVITY_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(UPDATE + "_id").build();

		// Path pour l'Uri de supression de tous les enregistrements
		// URI: user_activities/delete_all
		public static final String DELETE_USER_ACTIVITIES_PATH = TBNAME + "/"
				+ DELETE + "_all";
		public static final int DELETE_USER_ACTIVITIES_TOKEN = 5400;
		public static final Uri DELETE_USER_ACTIVITIES_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(DELETE + "_all").build();

		// Path pour l'Uri de supression d'un enregistrement
		// URI : user_activities/delete_id/#
		public static final String DELETE_USER_ACTIVITY_PATH = TBNAME + "/"
				+ DELETE + "_id/#";
		public static final int DELETE_USER_ACTIVITY_TOKEN = 5401;

		public static final Uri DELETE_USER_ACTIVITY_URI = URI_BASE_USER_ACTIVITIES
				.buildUpon().appendPath(DELETE + "_id").build();
	...
	public static final class View_NRJ_QtyRef {
		...
		public static final int VIEW_NRJ_QTYREF_TOKEN = 6100;

		public static final Uri VIEW_NRJ_QTYREF_URI = BASE_URI.buildUpon()
				.appendPath(VIEW_NRJ_QTYREF_PATH).build();
	...
	public static final class View_UAC_Data {
		...
		public static final Uri VIEW_UAC_DATA_URI = BASE_URI.buildUpon()
				.appendPath(VIEW_UAC_DATA_PATH).build();
	...
	public static final class XX_View_Energies implements BaseColumns {
		...
		public static final int SELECT_VIEW_ENERGIES_TOKEN = 10100;

		// Path pour l'Uri de séléction d'un enregistrement
		public static final String SELECT_VIEW_ENERGIES_BY_ID = "view_energies/#";
		public static final int SELECT_VIEW_ENERGIES_BY_ID_TOKEN = 10101;
	...
	public enum REQUESTS_LIST {
		...
		, SELECT_ALL_ENERGIES, SELECT_ONE_ENERGY_BY_ID, SELECT_ENERGIES_LIKE, UPDATE_ENERGY,

		MIME_ENERGY_DIR, SELECT_USER_ACTIVITY, UPDATE_USER_ACTIVITY, MIME_ENERGY_TYPE, SELECT_USER_ACTIVITIES_BY_DATE, DELETE_USER_ACTIVITY, SELECT_DB_VERSION
	}
	...
	public static final class TOKEN_MAP {
		...
		public TOKEN_MAP() {
			...
			_in.put(TB_Party_rel.S03_ALL_EQUIV_FOR_UAC_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_Party_rel.S04_QTY_REF_INTER_FOR_NRJ_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_Party_rel.S05_EQUIV_REF_INTER_FOR_NRJ_TOKEN,
					REQUESTS_LIST.NONE);
			...
			_in.put(TB_Energies.SELECT_ALL_ENERGIES_TOKEN,
					REQUESTS_LIST.SELECT_ALL_ENERGIES);
			_in.put(TB_Energies.SELECT_ONE_ENERGY_BY_ID_TOKEN,
					REQUESTS_LIST.SELECT_ONE_ENERGY_BY_ID);
			_in.put(TB_Energies.SELECT_ENERGIES_LIKE_TOKEN,
					REQUESTS_LIST.SELECT_ENERGIES_LIKE);
			_in.put(TB_Energies.INSERT_ENERGY_TOKEN,
					REQUESTS_LIST.INSERT_ENERGY);
			_in.put(TB_Energies.UPDATE_ENERGY_ID_TOKEN, REQUESTS_LIST.NONE);

			_in.put(TB_UserActivities.S00_USER_ACTIVITIES_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_UserActivities.SELECT_USER_ACTIVITY_BY_ID_TOKEN,
					REQUESTS_LIST.SELECT_USER_ACTIVITY);
			_in.put(TB_UserActivities.SELECT_USER_ACTIVITIES_BY_DATE_TOKEN,
					REQUESTS_LIST.SELECT_USER_ACTIVITIES_BY_DATE);
			_in.put(TB_UserActivities.SELECT_USER_ACTIVITIES_BY_TYPE_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_UserActivities.INSERT_USER_ACTIVITY_TOKEN,
					REQUESTS_LIST.INSERT_USER_ACTIVITY);
			_in.put(TB_UserActivities.DELETE_USER_ACTIVITIES_TOKEN,
					REQUESTS_LIST.NONE);
			_in.put(TB_UserActivities.DELETE_USER_ACTIVITY_TOKEN,
					REQUESTS_LIST.DELETE_USER_ACTIVITY);

			_in.put(TB_UserActivities.UPDATE_USER_ACTIVITIES_TOKEN,
					REQUESTS_LIST.NONE);

			_in.put(TB_Units.SELECT_UNITS_TOKEN, REQUESTS_LIST.SELECT_ALL_UNITS);
			_in.put(TB_Units.SELECT_UNITY_TOKEN,
					REQUESTS_LIST.SELECT_ONE_UNITY_BY_ID);
			...
			//
			_in.put(View_NRJ_QtyRef.VIEW_NRJ_QTYREF_TOKEN,
					REQUESTS_LIST.SELECT_QTYREF_OF_NRJ);
			//
			_in.put(View_UA_UAC_link.VIEW_UAC_FOR_UA_TOKEN,
					REQUESTS_LIST.SELECT_ALL_UAC_OF_UA);
			//
			_in.put(View_Qty.VIEW_QTY_BY_ID_TOKEN,
					REQUESTS_LIST.SELECT_QTY_BY_ID);

			//
			_in.put(CustomQuery.DB_VERSION_TOKEN,
					REQUESTS_LIST.SELECT_DB_VERSION);
			//
			_in.put(TB_Energies.UPDATE_ENERGY_ID_TOKEN,
					REQUESTS_LIST.UPDATE_ENERGY);
			//
			_in.put(TB_UserActivities.UPDATE_USER_ACTIVITY_TOKEN,
					REQUESTS_LIST.UPDATE_USER_ACTIVITY);
	...
	public static UriMatcher buildUriMatcher() {
		...
		matcher.addURI(authority, TB_Party_rel.S00_PARTY_REL_PATH,
				TB_Party_rel.S00_PARTY_REL_TOKEN);
		matcher.addURI(authority, TB_Party_rel.S01_PARTY_REL_BY_ID_PATH,
				TB_Party_rel.S01_PARTY_REL_BY_ID_TOKEN);
		matcher.addURI(authority, TB_Party_rel.S02_ALL_UAC_FOR_UA_PATH,
				TB_Party_rel.S02_ALL_UAC_FOR_UA_TOKEN);
		...
		matcher.addURI(authority,
				TB_Party_rel.S05_EQUIV_REF_INTER_FOR_NRJ_PATH,
		...
		matcher.addURI(authority, TB_Energies.SELECT_ALL_ENERGIES_PATH,
				TB_Energies.SELECT_ALL_ENERGIES_TOKEN);
		matcher.addURI(authority, TB_Energies.SELECT_ONE_ENERGY_BY_ID_PATH,
				TB_Energies.SELECT_ONE_ENERGY_BY_ID_TOKEN);
		matcher.addURI(authority, TB_Energies.SELECT_ENERGIES_LIKE_PATH,
				TB_Energies.SELECT_ENERGIES_LIKE_TOKEN);
		matcher.addURI(authority, TB_Energies.INSERT_ENERGY_PATH,
				TB_Energies.INSERT_ENERGY_TOKEN);
		matcher.addURI(authority, TB_Energies.UPDATE_ENERGY_ID_PATH,
				TB_Energies.UPDATE_ENERGY_ID_TOKEN);
		// ----------------------------------------------------------------
		// Match pour la table des untitées
		// ----------------------------------------------------------------

		// Match pour le select sur la table des unitées
		matcher.addURI(authority, TB_Units.SELECT_ALL_UNITS,
				TB_Units.SELECT_UNITS_TOKEN);
		matcher.addURI(authority, TB_Units.SELECT_UNITY,
				TB_Units.SELECT_UNITY_TOKEN);
		...
		// ----------------------------------------------------------------
		matcher.addURI(authority, View_UAC_Data.VIEW_UAC_DATA_PATH,
				View_UAC_Data.VIEW_UAC_DATA_TOKEN);

		// Match pour la vue de selection des liens NRJ<->QtyRef
		// ----------------------------------------------------------------
		matcher.addURI(authority, View_NRJ_QtyRef.VIEW_NRJ_QTYREF_PATH,
				View_UAC_Data.VIEW_UAC_DATA_TOKEN);
		...
		matcher.addURI(authority,
				TB_UserActivities.SELECT_USER_ACTIVITY_BY_ID_PATH,
				TB_UserActivities.SELECT_USER_ACTIVITY_BY_ID_TOKEN);

		matcher.addURI(authority,
				TB_UserActivities.SELECT_USER_ACTIVITIES_BY_DATE_PATH,
				TB_UserActivities.SELECT_USER_ACTIVITIES_BY_DATE_TOKEN);

		matcher.addURI(authority,
				TB_UserActivities.SELECT_USER_ACTIVITIES_BY_TYPE_PATH,
		...
		matcher.addURI(authority, CustomQuery.DB_VERSION_PATH,
